import type { DataBanCreate, DataMemberEdit, MemberCompositeKey, Role } from "stoat-api";
...
export declare class ServerMember {
     ...
     */
    get orderedRoles(): (Partial<Omit<Role, 'permissions'> & {
        permissions: {
            a: bigint;
            d: bigint;
        };
     ...
     */
    get hoistedRole(): Partial<Omit<Role, 'permissions'> & {
        permissions: {
            a: bigint;
            d: bigint;
        };
